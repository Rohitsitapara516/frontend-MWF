...
export default function AdminSidebar() {
  return (
    <div className="admin-sidebar bg-dark col-md-3 m-0 p-3 sticty">
  <ul className="sidebar-link m-0 p-0">
    ...
    <li className="dropdown">
      ...
      <ul className="dropdown-menu bg-white text-dark">
        <li>
          <a href="/admin-login/add-subcategory"  className="d-block  text-dark text-decoration-none">
            <span className="bi bi-cart" /> Add SubCategory
          </a>
        </li>
        <li>
          <a href="/admin-login/manage-subcategory"  className="d-block  text-dark text-decoration-none">

...
export default function Dashboard(){
    return(
        ...
        <div className="admin-dashboard col-md-9 p-3">
            ...
            <hr className="border border-1 bg-dark w-50 ms-5" aling="left"/>
            <div className="row">
                <div className="col-md-3 ms-5 p-3 mt-2 bg-success">
                    <p className="text-center fs-4">Total Customers</p>
                    <p className="text-center">
                        <button type="button" className="btn btn-sm btn-danger"><span className="badge badge-danger start-0 top-0"><i className="bi bi-person"/></span>100</button>
                    </p>
                     </div>
                    ...
                    <div className="col-md-3 ms-5 p-3 mt-2 bg-danger">
                    <p className="text-center fs-4">Total Contact</p>
                    <p className="text-center">
                        <button type="button" className="btn btn-sm btn-danger"><span className="badge badge-danger start-0 top-0"><i className="bi bi-person"/></span>100</button>
                    </p>
                     </div>
                    ...
                    <div className="col-md-3 ms-5 p-3 mt-2 bg-success">
                    <p className="text-center fs-4">Total Review</p>
                    <p className="text-center">
                        <button type="button" className="btn btn-sm btn-danger"><span className="badge badge-danger start-0 top-0"><i className="bi bi-person"/></span>100</button>
                    </p>
                </div>

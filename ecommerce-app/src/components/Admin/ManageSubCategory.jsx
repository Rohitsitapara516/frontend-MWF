...
// fetch a category inside of manage category tables
    ...
    {/* admin dashboard content */}
        ...
        <div className="row text-center d-flex justify-content-center align-items-center">
         <div className="col-md-10 ms-2 p-3 mt-2 shadow">
          <h2 className="ms-1 p-4 mt-3">Manage Category here</h2>
         ...
         <tr>
            ...
            <th className="p-2">subCategoryName</th>
         ...
         {data && data.map((item)=>{
            ...
            <td><button type='button' className='btn btn-sm bg-danger btn-danger' onClick={()=>Navigate(`/admin-login/delete-category/${item.id}`)}><span className='bi bi-trash text-white'></span></button> | <button type='button' className='btn btn-sm bg-primary' onClick={()=>Navigate(`/admin-login/edit-category/${item.id}`)}><span className='bi bi-pencil text-white'></span></button></td>
            </tr>

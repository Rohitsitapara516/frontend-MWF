...
export default function Content() {
  return (
    ...
    <>
  <section id="be-pro-content" className="p-5">
    {/* popular products */}
...
<div className="be-pro-adevrtisment container mt-3 p-5">

  {/* FIRST BANNER */}
  <div className="row">
    <div className="col-md-5 col-12 mx-auto mt-3 pro-adv">
      <div className="row">
        <div className="col-md-8 col-12 text-white p-3 text-center">
          <p>Suits</p>
          <h2>Slim Fit Prince of Wales Check Wool</h2>
          <p>26-10-2023</p>
        </div>

        <div className="col-md-4 col-12 text-center pro-adv-img">
          <img
            src={adv}
            alt="adv"
            title="advertisement"
  ...
  <div className="row mt-4">
    <div className="col-md-5 col-12 mx-auto mt-3 pro-adv">
      <div className="row">
        <div className="col-md-8 col-12 text-white p-4 text-center">
          <p>Suits</p>
          <h2>Slim Fit Prince of Wales Check Wool</h2>
          <p>26-10-2023</p>
        </div>
  ...
  <div className="row d-flex justify-content-center">
    ...
    {/* LEFT TEXT BLOCK */}
    <div className="col-md-7 col-12 text-center mt-3 mt-md-0 px-3">
      <div className="p-3 p-md-5">
        <p className="m-0">Date 26-10-2023</p>
        <p className="fs-5">
    ...
    {/* RIGHT BOX */}
    <div className="col-md-4 col-12 text-center mt-3 mt-md-0 px-3">
      <div className="be-pro-popular-right p-3">

    ...
    return(
        ...
        <section id="be-pro-content" className="p-5 mt-3">
                ...
                <div className="row justify-content-evenly">
                    <div className="col-md-3 bg-dark p-3">
                        <p className="text-white text-center">
                            <span className="bi bi-fire fs-2" ></span>
                        </p>
                        <h3 className="text-center text-white">Popular Product</h3>
                        <p>
                            <summary className="text-white text-center">More Product</summary>
                        </p>
                    </div>
         ...
         <div className="row justify-content-evenly mt-5"></div>
          ...
          <div className="row justify-content-evenly mt-5 items">
            ...
            {data && data.map((row)=>{
                return(
                    ...
                    <p className="text-white text-center">
                   <img src={product1} className='img-fluid w-75' />
                  </p>
